...
public:
    ...
    * 
    * @param i2c reference to i2c peripheral to use. The i2c peripheral is assumed to be initialized
    ...
    */
    ...
    /**
     * @brief Dumps the entire content of the EEPROM into 32768 bytes buffer
     * 
